...
/* =========================================================
   DECORATIVE SPIRAL-NOTEBOOK BINDING
========================================================= */

function SpiralBinding({ count = 11 }: { count?: number }) {
  return (
    <div className="pointer-events-none absolute inset-x-8 -top-4 z-10 flex justify-between sm:inset-x-12">
...
function CoilRing() {
  return (
    ...
    >
      {/* soft shadow the ring casts on the page */}
      <ellipse cx="10" cy="27" rx="6" ry="3" fill="rgb(var(--color-heading))" opacity="0.12" />

      {/* main coil loop — stadium ring outline */}
      <rect
        x="2"
        y="1"
        width="16"
      ...
      {/* glossy plastic highlight streak */}
      <path
        d="M 5 6 Q 4 15 5 24"
        fill="none"
